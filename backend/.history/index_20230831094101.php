...
ini_set("error_log", "/opt/lampp/htdocs/reservas-hotel/baphp_error_log"); // Cambia "/ruta/a/tu/aplicacion/" por la ruta donde deseas que se guarde el archivo de registro de errores
